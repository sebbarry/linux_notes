...
- this is useful if we believe that there is a file that contains a virus. Removing permissions temporarily can help alleviate damage caused by a virus.
- this is typically done through a mask.
