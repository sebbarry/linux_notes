...
Hostname resolution: 
The hostname resolution dpends on a switch factor called "nsswitch.conf"
This file is a nameservice configuration file that defines the search order of the network databases based on the name server. This file involves the hostname resolution.
